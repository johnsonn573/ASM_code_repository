...
cov.names=list.files("/home/Shared/ConneelyLab/nick_method/scRRBS/sc_bam/cov_files_paired/")
...
x=read.table(paste0("/home/Shared/ConneelyLab/nick_method/scRRBS/sc_bam/cov_files_paired/",cov.names)[1])
...
for (i in 2:length(cov.names)){
  print(i)
  x=read.table(paste0("/home/Shared/ConneelyLab/nick_method/scRRBS/sc_bam/cov_files_paired/",cov.names)[i])
  colnames(x)=c("chr","start","end","prop","M","U")
  x.gr=makeGRangesFromDataFrame(x)
  na1=na1&!cg1%in%x.gr
  na2=na2&!cg2%in%x.gr
...
save(na1,file="/home/Shared/ConneelyLab/nick_method/scRRBS/na1_B_v3.rda")
save(na2,file="/home/Shared/ConneelyLab/nick_method/scRRBS/na2_B_v3.rda")
