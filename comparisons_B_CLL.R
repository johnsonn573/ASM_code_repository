...
pdf(file="C:/Users/User/Dropbox/projects/scrrbs/figs/comparison_B_CLL_v3.pdf",width=30*.4,height=14*.4)
...
save(list=c("matrix.OR","matrix.OR.pval"),file="C:/Users/User/Dropbox/projects/scrrbs/data/comparisons_B_CLL_v3.rda")

load("C:/Users/User/Dropbox/projects/scrrbs/data/comparisons_B_CLL.rda",verbose=T)
range(matrix.OR)
load("C:/Users/User/Dropbox/projects/scrrbs/data/comparisons_B_CLL_v3.rda",verbose=T)

load("C:/Users/User/Dropbox/projects/scrrbs/data/comparisons_B_CLL_v3.rda")
