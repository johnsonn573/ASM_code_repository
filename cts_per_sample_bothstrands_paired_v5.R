...
# Modified on June 4, 2021
# Includes

# 02/10/2021
# Modified to do B01, B02, B03
# Modified on 02/25/2021 because the U asm reads and M asm reads were getting switched

# 02/04/2021
# Script purpose
# This is a copy of cts_per_sample_bothstrands_v3.R.
